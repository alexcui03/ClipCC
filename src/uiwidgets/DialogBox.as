...
public class DialogBox extends Sprite {
	...
	public static function notifybuttontext(title:String, msg:String, stage:Stage = null, leftJustify:Boolean = false, okFunction:Function = null, cancelFunction:Function = null, context:Dictionary = null,buttontext:String='OK'):void {
		var d:DialogBox = new DialogBox(okFunction, cancelFunction);
		d.leftJustify = leftJustify;
		d.addTitle(title);
		d.addText(msg);
		d.addButton(buttontext, d.accept);
		if (context) d.updateContext(context);
		d.showOnStage(stage ? stage : Scratch.app.stage);
	}
	
	public static function notifyReturnValuebuttontext(title:String, msg:String, value:String, stage:Stage = null, leftJustify:Boolean = false, okFunction:Function = null, cancelFunction:Function = null, context:Dictionary = null,buttontext:String='OK'):void {
		var d:DialogBox = new DialogBox(okFunction, cancelFunction);
		d.leftJustify = leftJustify;
		d.addTitle(title);
		d.addText(msg);
		d.addField("参数",120,value);
		d.addButton(buttontext, d.accept);
		if (context) d.updateContext(context);
		d.showOnStage(stage ? stage : Scratch.app.stage);
	}
	...
	private function drawBackground():void {
		var titleBarColors:Array = /*[0xE0E0E0, 0xD0D0D0]*/[0xc0c1c3,0xc0c1c3]; // old: CSS.titleBarColors;
		var borderColor:int = /*0xB0B0B0;*/0xc0c1c3; // old: CSS.borderColor;
