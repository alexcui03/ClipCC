...
public class Resources {
	...
	[Embed(source='fonts/HuaWenXiHei.ttf', fontName='Chinese fine black', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font3:Class;
	...
	//[Embed(source='fonts/XiaoMiLanTing.ttf', fontName='MI Lanting', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font7:Class; //AdobeAIR不可用
	[Embed(source='fonts/Helvetica-Bold.ttf', fontName='Helvetica', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font7:Class;
	...
	[Embed(source='UI/topbar/wechat.png')] private static const wechat:Class;
	// Buttons
	...
	[Embed(source='UI/buttons/checkboxOff.png')] private static const checkboxOff:Class;
	[Embed(source='UI/buttons/checkboxOn.png')] private static const checkboxOn:Class;
	...
	[Embed(source='UI/paint/flipHOff.png')] private static const flipHOff:Class;
	[Embed(source='UI/paint/flipHOn.png')] private static const flipHOn:Class;
	[Embed(source='UI/paint/flipVOff.png')] private static const flipVOff:Class;
	[Embed(source='UI/paint/flipVOn.png')] private static const flipVOn:Class;
	...
	/*[Embed(source='UI/paint/swatchesOff.png')] private static const swatchesOn:Class;
	[Embed(source='UI/paint/swatchesOn.png')] private static const swatchesOff:Class;
	[Embed(source='UI/paint/wheelOff.png')] private static const wheelOn:Class;
	[Embed(source='UI/paint/wheelOn.png')] private static const wheelOff:Class;
	...
	// Paint Tools
	[Embed(source='UI/paint/ellipseOff.png')] private static const ellipseOn:Class;
	[Embed(source='UI/paint/ellipseOn.png')] private static const ellipseOff:Class;
	[Embed(source='UI/paint/cropOff.png')] private static const cropOn:Class;
	[Embed(source='UI/paint/cropOn.png')] private static const cropOff:Class;
	[Embed(source='UI/paint/flipHOff.gif')] private static const flipHOn:Class;
	[Embed(source='UI/paint/flipHOn.gif')] private static const flipHOff:Class;
	[Embed(source='UI/paint/flipVOff.gif')] private static const flipVOn:Class;
	[Embed(source='UI/paint/flipVOn.gif')] private static const flipVOff:Class;
	[Embed(source='UI/paint/pathOff.png')] private static const pathOn:Class;
	[Embed(source='UI/paint/pathOn.png')] private static const pathOff:Class;
	[Embed(source='UI/paint/pencilCursor.gif')] private static const pencilCursor:Class;
	[Embed(source='UI/paint/textOff.png')] private static const textOn:Class;
	[Embed(source='UI/paint/textOn.png')] private static const textOff:Class;
	[Embed(source='UI/paint/selectOff.png')] private static const selectOn:Class;
	[Embed(source='UI/paint/selectOn.png')] private static const selectOff:Class;
	[Embed(source='UI/paint/rotateCursor.png')] private static const rotateCursor:Class;
	[Embed(source='UI/paint/eyedropperOff.png')] private static const eyedropperOn:Class;
	[Embed(source='UI/paint/eyedropperOn.png')] private static const eyedropperOff:Class;
	[Embed(source='UI/paint/setCenterOn.gif')] private static const setCenterOff:Class;
	[Embed(source='UI/paint/setCenterOff.gif')] private static const setCenterOn:Class;
	[Embed(source='UI/paint/rectSolidOn.png')] private static const rectSolidOff:Class;
	[Embed(source='UI/paint/rectSolidOff.png')] private static const rectSolidOn:Class;
	[Embed(source='UI/paint/rectBorderOn.png')] private static const rectBorderOff:Class;
	[Embed(source='UI/paint/rectBorderOff.png')] private static const rectBorderOn:Class;
	[Embed(source='UI/paint/ellipseSolidOn.png')] private static const ellipseSolidOff:Class;
	[Embed(source='UI/paint/ellipseSolidOff.png')] private static const ellipseSolidOn:Class;
	[Embed(source='UI/paint/ellipseBorderOn.png')] private static const ellipseBorderOff:Class;
	[Embed(source='UI/paint/ellipseBorderOff.png')] private static const ellipseBorderOn:Class;

	// Vector
	[Embed(source='UI/paint/vectorRectOff.png')] private static const vectorRectOn:Class;
	[Embed(source='UI/paint/vectorRectOn.png')] private static const vectorRectOff:Class;
	[Embed(source='UI/paint/vectorEllipseOff.png')] private static const vectorEllipseOn:Class;
	[Embed(source='UI/paint/vectorEllipseOn.png')] private static const vectorEllipseOff:Class;
	[Embed(source='UI/paint/vectorLineOff.png')] private static const vectorLineOn:Class;
	[Embed(source='UI/paint/vectorLineOn.png')] private static const vectorLineOff:Class;
	[Embed(source='UI/paint/patheditOff.png')] private static const patheditOn:Class;
	[Embed(source='UI/paint/patheditOn.png')] private static const patheditOff:Class;
	[Embed(source='UI/paint/groupOff.png')] private static const groupOn:Class;
	[Embed(source='UI/paint/groupOn.png')] private static const groupOff:Class;
	[Embed(source='UI/paint/ungroupOff.png')] private static const ungroupOn:Class;
	[Embed(source='UI/paint/ungroupOn.png')] private static const ungroupOff:Class;
	[Embed(source='UI/paint/frontOff.png')] private static const frontOn:Class;
	[Embed(source='UI/paint/frontOn.png')] private static const frontOff:Class;
	[Embed(source='UI/paint/backOn.png')] private static const backOff:Class;
	[Embed(source='UI/paint/backOff.png')] private static const backOn:Class;
	[Embed(source='UI/paint/paintbrushOff.png')] private static const vpaintbrushOn:Class;
	[Embed(source='UI/paint/paintbrushOn.png')] private static const vpaintbrushOff:Class;

	// Bitmap
	[Embed(source='UI/paint/rectOff.png')] private static const rectOn:Class;
	[Embed(source='UI/paint/rectOn.png')] private static const rectOff:Class;
	[Embed(source='UI/paint/paintbucketOn.png')] private static const paintbucketOff:Class;
	[Embed(source='UI/paint/paintbucketOff.png')] private static const paintbucketOn:Class;

	[Embed(source='UI/paint/editOff.png')] private static const editOn:Class;
	[Embed(source='UI/paint/editOn.png')] private static const editOff:Class;

	[Embed(source='UI/paint/sliceOn.png')] private static const sliceOff:Class;
	[Embed(source='UI/paint/sliceOff.png')] private static const sliceOn:Class;
	[Embed(source='UI/paint/wandOff.png')] private static const wandOn:Class;
	[Embed(source='UI/paint/wandOn.png')] private static const wandOff:Class;

	[Embed(source='UI/paint/eraserOn.png')] private static const eraserOff:Class;
	[Embed(source='UI/paint/eraserOff.png')] private static const eraserOn:Class;
	[Embed(source='UI/paint/saveOn.png')] private static const saveOff:Class;
	[Embed(source='UI/paint/saveOff.png')] private static const saveOn:Class;
	[Embed(source='UI/paint/cloneOff.png')] private static const cloneOn:Class;
	[Embed(source='UI/paint/cloneOn.png')] private static const cloneOff:Class;
	[Embed(source='UI/paint/lassoOn.png')] private static const lassoOff:Class;
	[Embed(source='UI/paint/lassoOff.png')] private static const lassoOn:Class;
	[Embed(source='UI/paint/lineOn.png')] private static const lineOff:Class;
	[Embed(source='UI/paint/lineOff.png')] private static const lineOn:Class;

	[Embed(source='UI/paint/bitmapBrushOff.png')] private static const bitmapBrushOn:Class;
	[Embed(source='UI/paint/bitmapBrushOn.png')] private static const bitmapBrushOff:Class;
	[Embed(source='UI/paint/bitmapEllipseOff.png')] private static const bitmapEllipseOn:Class;
	[Embed(source='UI/paint/bitmapEllipseOn.png')] private static const bitmapEllipseOff:Class;
	[Embed(source='UI/paint/bitmapPaintbucketOff.png')] private static const bitmapPaintbucketOn:Class;
	[Embed(source='UI/paint/bitmapPaintbucketOn.png')] private static const bitmapPaintbucketOff:Class;
	[Embed(source='UI/paint/bitmapRectOff.png')] private static const bitmapRectOn:Class;
	[Embed(source='UI/paint/bitmapRectOn.png')] private static const bitmapRectOff:Class;
	[Embed(source='UI/paint/bitmapSelectOff.png')] private static const bitmapSelectOn:Class;
	[Embed(source='UI/paint/bitmapSelectOn.png')] private static const bitmapSelectOff:Class;
	[Embed(source='UI/paint/magicEraserOn.png')] private static const magicEraserOff:Class;
	[Embed(source='UI/paint/magicEraserOff.png')] private static const magicEraserOn:Class;
	[Embed(source='UI/paint/bitmapStampOff.png')] private static const bitmapStampOn:Class;
	[Embed(source='UI/paint/bitmapStampOn.png')] private static const bitmapStampOff:Class;
	[Embed(source='UI/paint/bitmapTextOff.png')] private static const bitmapTextOn:Class;
	[Embed(source='UI/paint/bitmapTextOn.png')] private static const bitmapTextOff:Class;
