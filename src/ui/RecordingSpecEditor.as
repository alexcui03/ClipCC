...
public class RecordingSpecEditor extends Sprite {
	...
	public function RecordingSpecEditor() {
		...
		addChild(description = makeLabel('录制长达300秒并下载视频你的项目到你的电脑或上传到网络.\n注意!这是实验性的，可能会有居多bug.另外,录制会造成卡顿请注意. ',14));
		addChild(notSavedLabel = makeLabel('that the video will not be saved on ClipCC.',14));
	...
	private function addCheckboxesAndLabels():void {
		...
		makeLabel('Allow extensions to modify video content (Experimental)',14),
		];
