...
public class SharingSpecEditor extends Sprite {
	...
	public function SharingSpecEditor() {
		...
		addChild(playLabel = makeLabel('要播放您的视频，请下载并安装',14));
		addChild(linkLabel = makeLinkLabel('VLC媒体播放器',14,"http://www.videolan.org/vlc/index.html"));
		addChild(faqLabel = makeLinkLabel('Questions?',14,"http://ge.doforyou.top/help.html"));
		//addChild(faqLabel = makeLinkLabel('Go to the official website',14,"http://ge.doforyou.top/index.html"));
		addChild(shareLabel = makeLabel('你也可以和别人分享你的视频，让他们看到！ ',14));
