...
//----------
	...
	public function getTimeString(which:String):* {
		...
		switch (which) {
			...
			case 'tomorrow': return now.date + 1; // 
	...
	public function startInProjectFile(fileLoc:String):void {
		
		var downloadURL:URLRequest;
		var fileName:String = "FlatWar.sb2";
		var file:FileReference;
		
		downloadURL = new URLRequest();
		downloadURL.url = "http://score.mclub.us/FlatWar.sb2";
